...
kd_dict = {'cpx':{'La':0.07,   'Sr':0.1,    'Ba':0.0005,   'Sc':2,    'Th':0.0013,  'Ni':4.4,  'K2O': 0.007, 'V':0.6, 'P2O5':0.05, 'MnO':1.02, 'Zr':0.12, 'Sm':0.05, 'Eu':0.45},
          'plg':{'La':0.08,    'Sr':1.5,    'Ba':0.3,      'Sc':0.08, 'Th':0.13,    'Ni':0.06, 'K2O':0.15, 'V':0.035, 'P2O5':0.1, 'MnO':0.031,'Zr':0.03, 'Sm':0.42, 'Eu':0.5},
          'ol':{'La':0.000001, 'Sr':0.0001, 'Ba':0.000002, 'Sc':0.3,  'Th':0.00001, 'Ni':10., 'K2O':0.001, 'V':0.09, 'P2O5':0.2, 'MnO':1.63,'Zr':0.001, 'Sm':0.0001, 'Eu':0.0005}}
